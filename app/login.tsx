  ...
  const formContent = (
    <>
      ...
      <View style={s.logoRow}>
        <Text style={s.logoText}>GottaGig</Text>
        ...
        <>
          ...
          {signupTab === 'artist' && !mVerifyPending && (
            <>
              ...
              <Text style={s.hint}>Used to identify you on GottaGig</Text>
          ...
          {signupTab === 'venue' && vSignUpState === 'form' && (
            <>
              ...
              {vAlreadyClaimed && (
                <View style={s.claimWarningBox}>
                  ...
                  <Text style={s.claimWarningBody}>
                    Submitting will start a dispute. The current manager has 7 days to respond. GottaGig admin will oversee the process.
                  </Text>
                </View>
              )}
              ...
              <Text style={s.hint}>Used to identify your venue on GottaGig</Text>
          ...
          {signupTab === 'agent' && !aVerifyPending && (
            <>
              ...
              <Text style={s.hint}>Used to identify your agency on GottaGig</Text>
