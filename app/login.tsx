  ...
  const formContent = (
    <>
      ...
      <View style={s.logoRow}>
        <Text style={s.logoText}>Twaylo Gigs</Text>
        ...
        <>
          ...
          {signupTab === 'artist' && !mVerifyPending && (
            <>
              ...
              <Text style={s.hint}>Used to identify you on Twaylo</Text>
          ...
          {signupTab === 'venue' && vSignUpState === 'form' && (
            <>
              ...
              {vAlreadyClaimed && (
                <View style={s.claimWarningBox}>
                  ...
                  <Text style={s.claimWarningBody}>
                    Submitting will start a dispute. The current manager has 7 days to respond. Twaylo admin will oversee the process.
                  </Text>
                </View>
              )}
              ...
              <Text style={s.hint}>Used to identify your venue on Twaylo</Text>
          ...
          {signupTab === 'agent' && !aVerifyPending && (
            <>
              ...
              <Text style={s.hint}>Used to identify your agency on Twaylo</Text>
