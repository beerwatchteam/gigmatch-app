...
const s = StyleSheet.create({
  ...
  filterPill:       { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 8, borderWidth: 1, borderColor: '#d0ccc7', paddingHorizontal: 12, paddingVertical: 7, backgroundColor: '#ffffff' },
